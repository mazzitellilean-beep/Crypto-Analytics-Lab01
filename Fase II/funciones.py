        ...
        if activo_encontrado:
            ...
            while int(opcion) != 8:
                ...
                if int(opcion) == 1:
                    ...
                    nuevas_unidades = input("\033[93mIngrese la cantidad que desea vender/comprar (utilice números negativos para vender):\033[0m ")
                    while not validar_unidades(nuevas_unidades, activo_encontrado):
                        nuevas_unidades = input("\033[93mIngrese la cantidad que desea vender/comprar (utilice números negativos para vender):\033[0m ")

                    activo_encontrado[5] += float(nuevas_unidades)
                    print("\033[92mUnidades en tesorería del activo modificadas exitosamente.\033[0m\n")
                    ...
                    print("\033[92mPuntaje de confianza del activo modificado exitosamente.\033[0m")
