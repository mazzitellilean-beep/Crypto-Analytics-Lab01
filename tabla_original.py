...
def tabla_cartera():
    ...
    '''Genera la cartera inicial con las posiciones en activos del catalogo.'''

    #items = [nombre, unidades]

    cartera = [
    ["Apple Inc.", 850000],
    ["Microsoft Corporation", 430000],
    ["NVIDIA Corporation", 210000],
    ["Bitcoin", 15000],
    ["Ethereum", 95000],
    ["SPDR S&P 500 ETF", 600000],
    ["Invesco QQQ Trust", 380000],
    ["Tesla Inc.", 500000],
    ["Amazon.com Inc.", 470000],
    ["Alphabet Inc.", 560000],
    ["Meta Platforms Inc.", 310000],
    ["Solana", 120000],
    ["Binance Coin", 75000],
    ["SPDR Gold Shares", 420000],
    ["iShares Silver Trust", 900000],
    ["Netflix Inc.", 185000],
    ["Berkshire Hathaway B", 320000],
    ["XRP", 5000000],
    ["Palantir Technologies", 750000],
    ["ARK Innovation ETF", 430000],
    ]
    return cartera
